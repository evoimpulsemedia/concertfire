...
class PerformersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create performer" do
    assert_difference('Performer.count') do
      post performers_url, params: { performer: { name: @performer.name, performer_id: @performer.performer_id } }
    end
  ...
  test "should update performer" do
    patch performer_url(@performer), params: { performer: { name: @performer.name, performer_id: @performer.performer_id } }
